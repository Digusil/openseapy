...
from snaa.core import CoreEvent, CoreEventList
from snaa.saving_utils import ask_to_proceed_with_overwrite
...
def load_event_from_hdf5(filepath: str, use_class: type = None):
    ...
    try:
        if use_class is None:
            from snaa.events import Event, SpontaneousActivityEvent
            from snaa.core import CoreEvent
...
def load_signal_from_hdf5(filepath: str, use_class: type = None):
    ...
    try:
        if use_class is None:
            ...
            from snaa.core import CoreSingleSignal
