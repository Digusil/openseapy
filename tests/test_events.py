...
from snaa.events import Event, EventList, EventDataFrame
...
class TestEvent(unittest.TestCase):
    ...
    def test_saving_loading(self):
        ...
        event.save('_data/test_event.h5')

        event2 = Event.load('_data/test_event.h5')
...
class TestEventList(unittest.TestCase):
    ...
    def test_saving_loading(self):
        ...
        event_list.save('_data/test_eventlist.h5')

        event_list2 = EventList.load('_data/test_eventlist.h5')
